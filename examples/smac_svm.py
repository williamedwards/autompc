...
scenario = Scenario({"run_obj": "quality",  # we optimize quality (alternatively runtime)
                     ...
                     "output_dir" : "smac_svm_out",
                     "shared_model" : True,
                     "input_psmac_dirs" : "smac_svm_out",
                     "deterministic": "true",
                     })
...
#tae = ExecuteTAFuncDict(svm_from_cfg)
smac = SMAC4HPO(scenario=scenario, rng=np.random.RandomState(45),
        tae_runner=svm_from_cfg, run_id=3)
