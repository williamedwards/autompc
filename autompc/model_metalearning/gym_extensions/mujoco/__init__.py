...
"""
Reference: Gym_Extensions: https://github.com/Breakend/gym-extensions
"""
...
custom_envs = {
    ...
    #--------------------------------------------------------------------
    # Environments with wall - HalfCheetah
    "HalfCheetahWall-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_half_cheetah:HalfCheetahWallEnv',
                max_episode_steps=1000,
                reward_threshold=4800.0,
                kwargs= dict()),
    "HalfCheetahWithSensor-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_half_cheetah:HalfCheetahWithSensorEnv',
                max_episode_steps=1000,
                reward_threshold=4800.0,
                kwargs= dict(model_path=os.path.dirname(gym.envs.__file__) + "/mujoco/assets/half_cheetah.xml")),
    
    # Environments with wall - Hopper
    "HopperSimpleWall-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_hopper:HopperSimpleWallEnv',
                max_episode_steps=1000,
                reward_threshold=3800.0,
                kwargs= dict()),
    "HopperWithSensor-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_hopper:HopperWithSensorEnv',
                max_episode_steps=1000,
                reward_threshold=3800.0,
                kwargs= dict(model_path=os.path.dirname(gym.envs.__file__) + "/mujoco/assets/hopper.xml")),
    
    # Environments with wall - Walker2d
    "Walker2dWall-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_walker2d:Walker2dWallEnv',
            max_episode_steps=1000,
            kwargs= dict()),
    "Walker2dWithSensor-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_walker2d:Walker2dWithSensorEnv',
            max_episode_steps=1000,
            kwargs= dict(model_path=os.path.dirname(gym.envs.__file__) + "/mujoco/assets/walker2d.xml")),
    
    # Environments with wall - Humanoid
    "HumanoidWall-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_humanoid:HumanoidWallEnv',
                max_episode_steps=1000,
                kwargs= dict()),
    "HumanoidWithSensor-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_humanoid:HumanoidWithSensorEnv',
                max_episode_steps=1000,
                kwargs= dict(model_path=os.path.dirname(gym.envs.__file__) + "/mujoco/assets/humanoid.xml")),
    "HumanoidStandupWithSensor-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_humanoid:HumanoidStandupWithSensorEnv',
                max_episode_steps=1000,
                kwargs= dict(model_path=os.path.dirname(gym.envs.__file__) + "/mujoco/assets/humanoidstandup.xml")),
    "HumanoidStandupAndRunWall-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_humanoid:HumanoidStandupAndRunWallEnv',
                max_episode_steps=1000,
                kwargs= dict()),
    "HumanoidStandupAndRunWithSensor-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_humanoid:HumanoidStandupAndRunEnvWithSensor',
                max_episode_steps=1000,
                kwargs= dict(model_path=os.path.dirname(gym.envs.__file__) + "/mujoco/assets/humanoidstandup.xml")),
    
    #----------------------------------------------------------------------
    "HumanoidStandupAndRun-v2" :
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_humanoid:HumanoidStandupAndRunEnv',
            max_episode_steps=1000,
            kwargs= dict()),
    ...
    "PusherMovingGoal-v2":
        dict(path='autompc.model_metalearning.gym_extensions.mujoco.modified_arm:PusherMovingGoalEnv',
